# memassist-gui-localization Specification

## Purpose
Define Korean and English localization behavior for the read-only memassist GUI, including persistent locale selection and deterministic fallback.
## Requirements
