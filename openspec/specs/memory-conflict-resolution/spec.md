# memory-conflict-resolution Specification

## Purpose
Define project-local conflict detection, relation judgment, deterministic resolution policy, and audit behavior for judge-extracted memory candidates before they are stored or reinforced.
## Requirements
